  ...
  return (
    <div className='flex flex-col w-80 overflow-hidden p-5 bg-white/75 shadow-xl gap-5 border-2 rounded-2xl border-white'>
        ...
        <div>
            ...
            <Link to={`/recipe-item/${item.id}`} className='text-sm p-3 mt-5 px-8 rounded-lg uppercase font-medium tracking-wider inline-block shadow-medium bg-black text-white'>Details</Link>
        </div>
    </div>
  )
}
